...
const initSlider = () => {
  ...
  imagesLoaded(slider, { background: true }, () => {
    ...
    const init = () => {
      ...
      gsap.set(slideActive.querySelector(".slide__background"), {
        autoAlpha: 1,
        y: "0%",
      });
      gsap.set(slideActive.querySelector(".slide__content_left"), {
        autoAlpha: 1,
        y: "0%",
      });
      gsap.set(slideActive.querySelector(".slide__content_right"), {
        autoAlpha: 1,
        y: "0%",
      });
    ...
    const scrollToSection = (sectionFrom, sectionTo) => {
      ...
      const contentRightFrom = sectionFrom.querySelector(
      ...
      tlScrollDown
        ...
        .to(
          contentLeftFrom,
          1.2,
          { autoAlpha: 0, y: "-100%", ease: "expo.inOut", clearProps: "y" },
          "0"
        )
        .fromTo(
          contentLeft,
          1.2,
          { autoAlpha: 0, y: "100%" },
          { autoAlpha: 1, y: "0%", ease: "expo.inOut" },
          "0"
        )
        .fromTo(
          titleRight,
    ...
    const updateNavigation = () => {
      const currentSlide = document.querySelector(".slide.is-active");
      mainNavLinkPrev.classList.toggle(
        "disabled",
        !currentSlide.previousElementSibling
      );
      mainNavLinkNext.classList.toggle(
        "disabled",
